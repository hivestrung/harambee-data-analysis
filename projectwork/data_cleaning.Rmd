...
knitr::opts_knit$set(root.dir = "/Users/xiaojianzhou/Documents/4. GitHub/harambee-data-analysis/projectwork")
library(tidyverse)
library(lubridate)
library(hablar)
library(caret)
...
```{r}
ggplot(df2, aes(y=daysWorked, x=numchildren)) + geom_point() + geom_count()
```
...
```{r}
ggplot(df2, aes(y=daysWorked, x=company_size)) + geom_point() + geom_count()
```
